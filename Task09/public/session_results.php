...
<?php
    if(isset($_REQUEST['student'])){
        ...
        $subjects_query = "SELECT id, `subject` as s, sr.points as p, su.course as c from subjects as su join session_results as sr on sr.student_id = '$student_id_sel' where sr.subject_id = su.id order by c;";
